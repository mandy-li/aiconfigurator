...
Usage:
  ...
  python collect_oneccl.py --oneccl_op all_reduce --dtype half --num_gpus 2
  python collect_oneccl.py --oneccl_op alltoall --dtype half --num_gpus 2
"""
...
def oneccl_benchmark(
    ...
    print(f"Running oneCCL benchmark: op={oneccl_op}, dtype={dtype}, "
          f"num_gpus={num_gpus}, {len(elem_counts)} sizes")
        ...
        try:
            ...
            with open(csv_path, encoding="utf-8") as csvf:
                ...
                for row in reader:
                    ...
                    print(f"    {ccl_coll}: {msg_bytes} bytes "
                          f"({msg_elements} elements), "
                          f"latency={latency_ms:.6f} ms")
    ...
    print(f"Done. Results appended to oneccl_perf.txt")
